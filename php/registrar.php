    ...
    if (isset($_POST["registrar"])) {
        ...
        try {
            ...
            while ($puntero = mysqli_fetch_assoc($resultado)) {
                ...
                if ($p_correo == $puntero["mailUsuario"]) {
            ...
            $consulta = "INSERT INTO `usuarios` (`idUsuario`, `mailUsuario`, `nombreUsuario`, `passUsuario`, `descripUsuario`, `fotoUsuario`) VALUES (NULL, '$mail', '$nombre', '$cifrado', NULL, NULL)";
